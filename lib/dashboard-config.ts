...
export const DEFAULT_CONFIG: DashboardConfig = {
  ...
  dashboard_data: {
    ...
    this_month: { revenue: 263.22, display: "$263.22" },
    last_month: { revenue: 0.0 },
    last_6_month: { revenue: 263.22, display: "$263.22", mode: "manual", locked: true },
  },
  statistics_report: {
    today: {
      revenue: 12.22,
  ...
  charts: {
    ...
    ecpm_chart: [
      ...
      { date: "13-03-2026", value: 35.33 },
    ],
  },
  recent_activity: [
    { type: "Revenue Update", date: "13-03-2026", value: 12.22 },
    { type: "Impression Update", date: "13-03-2026", value: 4306 },
    { type: "Click Update", date: "13-03-2026", value: 34 },
