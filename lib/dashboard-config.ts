...
export const DEFAULT_CONFIG: DashboardConfig = {
  ...
  dashboard_data: {
    ...
    this_month: { revenue: 387.0, display: "$387.00" },
    last_month: { revenue: 0.0 },
    last_6_month: { revenue: 387.0, display: "$387.00", mode: "manual", locked: true },
  },
  statistics_report: {
    today: {
      revenue: 22.0,
  ...
  charts: {
    ...
    ecpm_chart: [
      ...
      { date: "15-03-2026", value: 41.63 },
    ],
  },
  recent_activity: [
    { type: "Revenue Update", date: "15-03-2026", value: 22.0, domain: "fancydiamondchain.com" },
    { type: "Impression Update", date: "15-03-2026", value: 6157, domain: "fancydiamondchain.com" },
    { type: "Click Update", date: "15-03-2026", value: 170, domain: "fancydiamondchain.com" },
