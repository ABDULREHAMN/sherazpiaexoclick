...
export const DEFAULT_CONFIG: DashboardConfig = {
  ...
  dashboard_data: {
    ...
    this_month: { revenue: 737.55, display: "$737.55" },
    last_month: { revenue: 0.0 },
    last_6_month: { revenue: 737.55, display: "$737.55", mode: "manual", locked: true },
  },
  statistics_report: {
    today: {
      revenue: 18.00,
  ...
  charts: {
    ...
    ecpm_chart: [
      ...
      { date: "23-03-2026", value: 58.34 },
    ],
  },
  recent_activity: [
    { type: "Revenue Update", date: "23-03-2026", value: 18.00, domain: "fancydiamondchain.com" },
    { type: "Impression Update", date: "23-03-2026", value: 3980, domain: "fancydiamondchain.com" },
    { type: "Click Update", date: "23-03-2026", value: 120, domain: "fancydiamondchain.com" },
