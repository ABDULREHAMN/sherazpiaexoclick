...
export const DEFAULT_CONFIG: DashboardConfig = {
  ...
  dashboard_data: {
    ...
    this_month: { revenue: 64.22 },
    last_month: { revenue: 0.0 },
    last_6_month: { revenue: 64.22 },
  },
  statistics_report: {
    today: {
      revenue: 13.11,
