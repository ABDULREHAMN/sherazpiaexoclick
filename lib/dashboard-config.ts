...
export const DEFAULT_CONFIG: DashboardConfig = {
  ...
  dashboard_data: {
    ...
    this_month: { revenue: 1290.90, display: "$1290.90" },
    last_month: { revenue: 0.0 },
    last_6_month: { revenue: 1290.90, display: "$1290.90", mode: "manual", locked: true },
  },
  statistics_report: {
    today: {
      revenue: 25.35,
