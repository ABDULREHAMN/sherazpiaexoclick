...
export const DEFAULT_CONFIG: DashboardConfig = {
  ...
  dashboard_data: {
    ...
    this_month: { revenue: 227.22, display: "$227.22" },
    last_month: { revenue: 0.0 },
    last_6_month: { revenue: 227.22, display: "$227.22", mode: "manual", locked: true },
  },
  statistics_report: {
    today: {
      revenue: 16.0,
  ...
  charts: {
    ...
    ecpm_chart: [
      ...
      { date: "12-03-2026", value: 27.32 },
    ],
  },
  recent_activity: [
    { type: "Revenue Update", date: "12-03-2026", value: 16.0 },
    { type: "Impression Update", date: "12-03-2026", value: 5736 },
    { type: "Click Update", date: "12-03-2026", value: 84 },
