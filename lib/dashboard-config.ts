...
export const DEFAULT_CONFIG: DashboardConfig = {
  ...
  dashboard_data: {
    ...
    this_month: { revenue: 53.22 },
    last_month: { revenue: 0.0 },
    last_6_month: { revenue: 53.22 },
  },
  statistics_report: {
    today: {
      revenue: 2.11,
