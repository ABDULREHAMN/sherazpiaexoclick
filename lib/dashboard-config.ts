...
export const DEFAULT_CONFIG: DashboardConfig = {
  ...
  dashboard_data: {
    ...
    this_month: { revenue: 861.34, display: "$861.34" },
    last_month: { revenue: 0.0 },
    last_6_month: { revenue: 861.34, display: "$861.34", mode: "manual", locked: true },
  },
  statistics_report: {
    today: {
      revenue: 22.00,
  ...
  charts: {
    ...
    ecpm_chart: [
      ...
      { date: "25-03-2026", value: 12.31 },
    ],
  },
  recent_activity: [
    { type: "Revenue Update", date: "25-03-2026", value: 22.00, domain: "fancydiamondchain.com" },
    { type: "Impression Update", date: "25-03-2026", value: 306, domain: "fancydiamondchain.com" },
    { type: "Click Update", date: "25-03-2026", value: 135, domain: "fancydiamondchain.com" },
