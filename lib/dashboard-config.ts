...
export const DEFAULT_CONFIG: DashboardConfig = {
  ...
  dashboard_data: {
    ...
    this_month: { revenue: 340.22, display: "$340.22" },
    last_month: { revenue: 0.0 },
    last_6_month: { revenue: 340.22, display: "$340.22", mode: "manual", locked: true },
  },
  statistics_report: {
    today: {
      revenue: 20.22,
  ...
  recent_activity: [
    { type: "Revenue Update", date: "14-03-2026", value: 20.22, domain: "fancydiamondchain.com" },
    { type: "Impression Update", date: "14-03-2026", value: 10222, domain: "fancydiamondchain.com" },
    { type: "Click Update", date: "14-03-2026", value: 292, domain: "fancydiamondchain.com" },
