...
export const DEFAULT_CONFIG: DashboardConfig = {
  ...
  dashboard_data: {
    ...
    this_month: { revenue: 514.82, display: "$514.82" },
    last_month: { revenue: 0.0 },
    last_6_month: { revenue: 514.82, display: "$514.82", mode: "manual", locked: true },
  },
  statistics_report: {
    today: {
      revenue: 25.30,
  ...
  charts: {
    revenue_chart: [
      ...
      { date: "16-03-2026", value: 41.0 },
      { date: "17-03-2026", value: 43.3 },
      { date: "18-03-2026", value: 25.3 },
    ],
    impressions_chart: [
    ...
    ecpm_chart: [
      ...
      { date: "18-03-2026", value: 45.33 },
    ],
  },
  recent_activity: [
    { type: "Revenue Update", date: "18-03-2026", value: 25.30, domain: "fancydiamondchain.com" },
    { type: "Impression Update", date: "18-03-2026", value: 4738, domain: "fancydiamondchain.com" },
    { type: "Click Update", date: "18-03-2026", value: 139, domain: "fancydiamondchain.com" },
    ...
    { type: "Revenue Update", date: "16-03-2026", value: 41.0, domain: "fancydiamondchain.com" },
